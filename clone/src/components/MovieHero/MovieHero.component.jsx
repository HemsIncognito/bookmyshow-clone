...
const MovieHero = () => {
  ...
  return <>
      <div>
        ...
        <div className="flex flex-col gap-3 lg:hidden">
          ...
          <div className="flex items-center gap-3 md:px-4 md:w-screen text-xl px-4">
            ...
            <button onClick = {buyMovie} className="bg-red-600 w-full py-3 text-white font-semibold rounded-lg"> Buy ₹499 </button>
          </div>
      ...
      <div className='relative hidden w-full lg:block' style={{height: "30rem"}}>
        ...
        style={{backgroundImage: "linear-gradient(90deg, rgb(34, 34, 34) 24.95%, rgb(34, 34, 34, 0.95) 39%, rgba(34, 34, 34, 0.03) 97.47%, rgba(34, 34, 34) 100%)"}}
        >
