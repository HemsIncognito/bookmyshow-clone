    ...
    <>
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="text-white flex flex-col gap-2">
            ...
            <button className="bg-red-500 w-1/3 py-3 px-8 text-white font-semibold rounded-lg"> Rent ₹149 </button>
            <button className="bg-red-600 w-1/3 py-3 px-8 text-white font-semibold rounded-lg"> Buy ₹499 </button>
          </div>
    </div>
    </>
  )
